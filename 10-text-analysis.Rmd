...
An important note about a lot of the text functions we above is that some of these functions can only search or use one pattern at a time.  For example, consider a situation in which we want to find all occurrences of the letters "a", "b", and "c" for the `presidents` vector. 
